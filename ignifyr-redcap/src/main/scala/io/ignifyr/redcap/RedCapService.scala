...
/**
 * Class for interacting with the ignifyr-redcap service.
 *
 * This class provides methods to retrieve notification URLs, save projects, and get projects from the ignifyr-redcap service.
 *
 * @param redCapServiceConfig The configuration object for the ignifyr-redcap service.
 */
class RedCapService(redCapServiceConfig: RedCapServiceConfig) extends LazyLogging {

  // Timeout duration for proxy requests to the ignifyr-redcap service
  private val timeout: FiniteDuration = 20.seconds

  /**
   * Retrieves the notification URL from the ignifyr-redcap service.
   *
  ...
  /**
   * Saves the provided RedCap project configurations to the ignifyr-redcap service.
   *
  ...
  /**
   * Retrieves the projects from the ignifyr-redcap service.
   *
  ...
  /**
   * Deletes the REDCap data of the project from Kafka topics via ignifyr-redcap service.
   *
