  ...
  "The service" should {
    ...
    "create a mapping within project" in {
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.mappingRepositoryFolderPath, projectId, s"${mapping1.id}${FileExtensions.JSON}")
          .toFile should exist
      }
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.mappingRepositoryFolderPath, projectId, s"${mapping2.id}${FileExtensions.JSON}")
          .toFile should exist
      }
    }
    ...
    "cannot delete a mapping from a project if it is referenced by some jobs" in {
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.jobRepositoryFolderPath, projectId, s"${job.id}${FileExtensions.JSON}")
          .toFile should exist
      }
      // delete a mapping
      Delete(
