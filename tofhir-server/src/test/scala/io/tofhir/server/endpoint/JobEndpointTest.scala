  ...
  "The service" should {
    ...
    "create a job within project" in {
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.jobRepositoryFolderPath, projectId, s"${job1.id}${FileExtensions.JSON}")
          .toFile should exist
      }
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.jobRepositoryFolderPath, projectId, s"${kafkaSourceJob.id}${FileExtensions.JSON}")
          .toFile should exist
      }
    }
    ...
    "prevent creation of jobs with malformed content" in {
      ...
      Post(
        ...
        FileUtils
          .getPath(
            toFhirEngineConfig.jobRepositoryFolderPath,
            projectId,
