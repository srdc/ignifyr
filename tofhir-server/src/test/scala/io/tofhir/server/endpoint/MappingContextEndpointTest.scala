  ...
  "The service" should {
    ...
    "create a mapping context within project" in {
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.mappingContextRepositoryFolderPath, projectId, mappingContext1)
          .toFile should exist
      }
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.mappingContextRepositoryFolderPath, projectId, mappingContext2)
          .toFile should exist
      }
    }
