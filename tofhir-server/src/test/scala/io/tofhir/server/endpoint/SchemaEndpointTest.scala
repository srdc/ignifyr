  ...
  "The service" should {
    ...
    "create a schema within project" in {
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.schemaRepositoryFolderPath, projectId, s"${schema1.id}${FileExtensions.JSON}")
          .toFile should exist
      }
      ...
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.schemaRepositoryFolderPath, projectId, s"${schema2.id}${FileExtensions.JSON}")
          .toFile should exist
      }
    }
    ...
    "create schemas having the same URL but different versions" in {
      Post(
        ...
        FileUtils
          .getPath(toFhirEngineConfig.schemaRepositoryFolderPath, projectId, s"${schema5.id}${FileExtensions.JSON}")
          .toFile should exist
      }
    }
