...
/**
 * Configuration class for the ignifyr-redcap.
 *
 * @param redCapServiceConfig The configuration object containing the settings for the ignifyr-redcap service.
 */
class RedCapServiceConfig(redCapServiceConfig: Config) {
  ...
  /**
   * The base endpoint URL for the ignifyr-redcap service.
   */
