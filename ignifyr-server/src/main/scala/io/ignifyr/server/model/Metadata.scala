package io.ignifyr.server.model

/**
 * Model that represents the metadata of the Ignifyr server.
 *
 ...
 * @param ignifyrRedcapVersion     The optional Ignifyr-Redcap server version.
...
case class Metadata(
    ...
    ignifyrRedcapVersion: Option[String],
