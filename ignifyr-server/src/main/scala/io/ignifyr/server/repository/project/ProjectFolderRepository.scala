package io.ignifyr.server.repository.project
...
import io.ignifyr.engine.model.{FhirMapping, FhirMappingJob}
 ...
 */
class ProjectFolderRepository(config: IgnifyrEngineConfig) extends IProjectRepository {
