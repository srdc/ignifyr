 ...
 */
case class LocalFhirTerminologyServiceSettings(
    folderPath: String,
    conceptMapFiles: Seq[ConceptMapFile] = Nil,
    codeSystemFiles: Seq[CodeSystemFile] = Nil
) extends TerminologyServiceSettings

/**
 * Metadata for a Concept map file for Ignifyr local terminology service
 *
 * @param id                unique id
 ...
 */
case class ConceptMapFile(
    id: String = UUID.randomUUID().toString,
    name: String,
    conceptMapUrl: String,
    sourceValueSetUrl: String,
    targetValueSetUrl: String
)

/**
 * Metadata for a code system file  for Ignifyr local terminology service
 *
 * @param id         unique id
 * @param name       Name of the file
