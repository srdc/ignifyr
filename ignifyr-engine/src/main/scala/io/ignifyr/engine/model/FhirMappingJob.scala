 ...
 *
 * @param cronExpression A UNIX crontab-like pattern split into five space-separated parts.
 * @param initialTime    If not specified, Ignifyr generates a time range between Java beginning (January 1, 1970) and next run time of task
 *                       If specified, Ignifyr generates a time range between initial time and next run time of task
 */
