package io.ignifyr.engine.execution.processing

import com.typesafe.scalalogging.Logger
import io.ignifyr.engine.config.IgnifyrConfig
import io.ignifyr.engine.execution.RunningJobRegistry
import io.ignifyr.engine.execution.processing.FileStreamInputArchiver._
import io.ignifyr.engine.model.ArchiveModes.ArchiveModes
import io.ignifyr.engine.model.{ArchiveModes, FhirMappingJobExecution, FileSystemSource}
...
class FileStreamInputArchiver(runningJobRegistry: RunningJobRegistry) {
  ...
  def startStreamingArchiveTask(): Unit = {
    ...
    timer.schedule(
      ...
      0,
      IgnifyrConfig.engineConfig.streamArchivingFrequency
    )
  }
